...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ka_lite_deploymentstory', (
            ...
            ('hardware_setup', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('deployment_setting', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
    ...
    models = {
        u'ka_lite.deploymentstory': {
            ...
            'deployment_setting': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'guest_blog_post': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'hardware_setup': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
