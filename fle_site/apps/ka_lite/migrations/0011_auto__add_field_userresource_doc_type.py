...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserResource.doc_type'
        db.add_column(u'ka_lite_userresource', 'doc_type',
                      self.gf('django.db.models.fields.CharField')(default='document', max_length=80),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserResource.doc_type'
        db.delete_column(u'ka_lite_userresource', 'doc_type')
