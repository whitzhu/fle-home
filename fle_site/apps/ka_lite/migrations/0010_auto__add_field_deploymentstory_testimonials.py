...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeploymentStory.testimonials'
        db.add_column(u'ka_lite_deploymentstory', 'testimonials',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeploymentStory.testimonials'
        db.delete_column(u'ka_lite_deploymentstory', 'testimonials')
