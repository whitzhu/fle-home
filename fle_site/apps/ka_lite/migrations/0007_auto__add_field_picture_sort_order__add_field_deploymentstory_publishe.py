...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Picture.sort_order'
        db.add_column(u'ka_lite_picture', 'sort_order',
                      self.gf('django.db.models.fields.FloatField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'DeploymentStory.published'
        db.add_column(u'ka_lite_deploymentstory', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Picture.sort_order'
        db.delete_column(u'ka_lite_picture', 'sort_order')

        # Deleting field 'DeploymentStory.published'
        db.delete_column(u'ka_lite_deploymentstory', 'published')
