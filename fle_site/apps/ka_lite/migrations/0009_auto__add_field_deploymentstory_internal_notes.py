...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeploymentStory.internal_notes'
        db.add_column(u'ka_lite_deploymentstory', 'internal_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeploymentStory.internal_notes'
        db.delete_column(u'ka_lite_deploymentstory', 'internal_notes')
